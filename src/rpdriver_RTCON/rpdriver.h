...
typedef struct {
  ...
  real_T PendPos_ZeroDown;             /* '<S2>/Trigonometric Function' */
  real_T PendPos_ZeroUp;               /* '<S2>/Trigonometric Function3' */
...
struct P_rpdriver_T_ {
  ...
  real_T DC_Ctrl1_Value;               /* Expression: 0
                                        ...
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: 0.25
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T SignalGenerator_Frequency;    /* Expression: 1/9
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
 ...
 * '<S2>'   : 'rpdriver/RP Driver/Alfa Normalization'
 */
