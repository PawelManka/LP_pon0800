...
void rpdriver_initialize(void)
{
  ...
  /* External mode info */
  rpdriver_M->Sizes.checksums[0] = (3347104648U);
  rpdriver_M->Sizes.checksums[1] = (2294902507U);
  rpdriver_M->Sizes.checksums[2] = (36932419U);
  rpdriver_M->Sizes.checksums[3] = (694638266U);
