...
{
  {
     ...
     */
    rtb_ResetEncoders = rpdriver_B.PendulumAnglerad + rpdriver_P.Constant_Value;
...
void rpdriver_initialize(void)
{
  ...
  /* External mode info */
  rpdriver_M->Sizes.checksums[0] = (3715651377U);
  rpdriver_M->Sizes.checksums[1] = (250808368U);
  rpdriver_M->Sizes.checksums[2] = (2073650397U);
  rpdriver_M->Sizes.checksums[3] = (2813781950U);
  ...
  /* Start for Scope: '<Root>/PlotState' */
  {
    ...
    static int_T rt_ScopeSignalPlotStyles[] = { 1, 1, 1, 1, 1, 1, 1, 0 };
